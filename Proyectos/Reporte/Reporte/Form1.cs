...
namespace Reporte
{
    ...
    {
        AccesoDato oDato = new AccesoDato(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Documents and Settings\Administrador\Escritorio\TUP\Prog 1\Proyectos\Reporte\Reporte\DBF_ABM_alumno_personas.mdb");
        public Form1()
        {
            InitializeComponent();
        }
